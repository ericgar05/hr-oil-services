            ...
            <div className="card-header-compact">
              <div className="header-main">
                ...
                <div className="actions-top">
                  ...
                  {hasPermission("administracion", "delete") && (
              ...
              <div className="header-sub">
                ...
                <button
                  ...
                  onClick={() => hasPermission("administracion", "write") && handleStatusClick(employee)}
                  style={{ cursor: hasPermission("administracion", "write") ? "pointer" : "default" }}
                >
